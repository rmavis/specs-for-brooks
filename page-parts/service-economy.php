...
$images = [
    ...
    Pagemaker::image_block(
        ...
        "Flexible Hours",
        "2017, acrylic and acrylic transfer on aluminum panel, 46 x 40 inches"
    ),
    Pagemaker::image_block(
        "/images/service_econ_4.jpg",
        "Amortize",
        "2017, acrylic and watercolor on birch panel, 24 x 20 inches"
    ),
    Pagemaker::image_block(
    ...
    Pagemaker::image_block(
        ...
        "Muscle Memory",
        "2016, acrylic and acrylic transfer on aluminum panel, 30 x 26 inches"
    ),
    Pagemaker::image_block(
